...
- (void)fetchContactsFromContactsFrameWork { //access contacts using contacts.framework
    ...
    NSArray *keyToFetch = @[CNContactEmailAddressesKey,CNContactFamilyNameKey,CNContactGivenNameKey,CNContactPhoneNumbersKey,CNContactPostalAddressesKey]; //contacts list key params to access using contacts.framework
